          ...
          $( ":jqmData(role='page'), :jqmData(role='dialog')" ).live( "pagecreate", function( e ) {                                                      
             ...
             $( ":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')", this ).each(function() {
                  ...
                  if ( o.addBackBtnFooter && 
                          ...
                          $('#inspiring-quotes-page').length>0) {
                      $newBtn = $( '<div data-role="navbar"><ul><li><button class="interactive-rotate-button" data-icon="refresh" data-position="fixed" data-theme="a">New Quote</button></li></ul></div>' )
                      .attr( "data-"+ $.mobile.ns +"theme", o.backBtnTheme || thisTheme )
                      .prependTo( $this );
                      } else if (o.addBackBtnFooter && 
                              role === "footer" &&
                              $('div').hasClass('interactive-message')){
